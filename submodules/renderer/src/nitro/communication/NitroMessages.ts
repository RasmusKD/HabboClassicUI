...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.MESSENGER_ALL_FRIENDS, FriendsStatusInfoEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.UNIT_ROTATION, RoomUnitRotationComposer);
        this._composers.set(OutgoingHeader.UNIT_MOVE, RoomUnitMovementComposer);
        ...
        this._composers.set(OutgoingHeader.MESSENGER_ALL_FRIENDS, UserFriendsComposer);
        ...
        this._composers.set(OutgoingHeader.USER_SETTINGS_ARROW_KEYS, UserSettingsArrowKeysComposer);
