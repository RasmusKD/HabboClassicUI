...
export class UserProfileParser implements IMessageParser
{
    ...
    private _respectReceived: number;
    ...
    public parse(wrapper: IMessageDataWrapper): boolean
    {
        ...
        this._respectReceived = wrapper.readInt();
    ...
    public get respectReceived(): number
    {
        return this._respectReceived;
    }
