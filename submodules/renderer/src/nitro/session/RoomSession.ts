...
export class RoomSession implements IRoomSession
{
    ...
    public sendRotationMessage(rotation: number): void
    {
        this._connection.send(new RoomUnitRotationComposer(rotation));
    }

    public sendMovementMessage(direction: number): void
    {
        this._connection.send(new RoomUnitMovementComposer(direction));
    }
