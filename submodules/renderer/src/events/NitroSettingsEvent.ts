...
export class NitroSettingsEvent extends NitroEvent
{
    ...
    public clone(): NitroSettingsEvent
    {
        ...
        clone._arrowKeys = this._arrowKeys;
    ...
    public get arrowKeys(): number
    {
        return this._arrowKeys;
    }

    public set arrowKeys(value: number)
    {
        this._arrowKeys = value;
    }
}
