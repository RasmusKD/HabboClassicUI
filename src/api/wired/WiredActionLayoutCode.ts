export class WiredActionLayoutCode
{
    ...
    public static ROTATION: number = 28;
    public static ROLLERSPEED: number = 29;
    public static POINTS_NO_GAME: number = 30;
    public static XYZ_MOVEMENT: number = 31;
    public static STACK_CHANCE: number = 32;
