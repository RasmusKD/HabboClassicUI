...
export interface LayoutGridBlankProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutGridBlank: FC<LayoutGridBlankProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-blank' ];
