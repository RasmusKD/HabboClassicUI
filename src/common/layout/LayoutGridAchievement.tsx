...
export interface LayoutGridAchievementProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutGridAchievement: FC<LayoutGridAchievementProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-achievement', 'border', 'border-1', 'border-black', 'rounded' ];
