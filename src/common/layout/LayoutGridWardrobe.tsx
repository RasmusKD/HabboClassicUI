...
export interface LayoutGridWardrobeProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutGridWardrobe: FC<LayoutGridWardrobeProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-wardrobe' ];
