...
export interface LayoutHCCataGridItemProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutHCCataGridItem: FC<LayoutHCCataGridItemProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-hc-item' ];
    ...
    return (
        <Column center={ center } position={ position } overflow={ overflow } column={ column } classNames={ getClassNames } style={ getStyle } { ...rest }>
