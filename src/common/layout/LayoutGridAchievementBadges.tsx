...
export interface LayoutGridAchievementBadgesProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutGridAchievementBadges: FC<LayoutGridAchievementBadgesProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-achievement-badges', 'rounded' ];
