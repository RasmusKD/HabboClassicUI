            ...
            <Flex overflow="hidden" className="w-100 pt-4 pb-4 pe-4 ps-3">
                <Column grow overflow="auto" justifyContent="between">
                    ...
                    { editable && (onChange !== null) &&
                        <textarea spellCheck="false" className="gift-message h-100" maxLength={ 140 } value={ message } onChange={ (e) => onChange(e.target.value) } placeholder={ LocalizeText('catalog.gift_wrapping_new.message_hint') }></textarea> }
                    { userName &&
