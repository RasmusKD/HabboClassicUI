...
{
    const { variant = null, fontWeight = null, fontSize = 0, align = null, bold = false, gfnb = false, gfbold = false, underline = false, italics = false, truncate = false, center = false, textEnd = false, small = false, wrap = false, noWrap = false, textBreak = false, ...rest } = props;
    ...
    const getClassNames = useMemo(() =>
    {
        ...
        if(gfnb) newClassNames.push('goldfish');
    ...
    }, [ variant, fontWeight, fontSize, align, bold, gfnb, gfbold, underline, italics, truncate, center, textEnd, small, wrap, noWrap, textBreak ]);
