...
export const AchievementsView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView uniqueKey="achievements" className="nitro-achievements no-resize" theme="primary">
                ...
                { !selectedCategory &&
                    <>
                        ...
                        <Column grow justifyContent="end" gap={ 1 }>
                            ...
                            <Text bold small center className="achievement-point-text-color">{ LocalizeText('achievements.categories.score', [ 'score' ], [ achievementScore.toString() ]) }</Text>
                        </Column>
                    </> }
                { selectedCategory &&
