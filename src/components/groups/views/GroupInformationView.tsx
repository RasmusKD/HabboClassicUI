...
export const GroupInformationView: FC<GroupInformationViewProps> = props =>
{
    ...
    return (
        <Grid className="group-grey-bg-border p-2" overflow={ overflow } { ...rest }>
            <Column className="group-badge-margin2" alignItems="center" size={ 4 } overflow="hidden">
                <Flex overflow="hidden" className="group-badge">
            ...
            <Column size={ 9 } justifyContent="between" overflow="auto">
                <Column overflow="hidden" gap={ 0 }>
                    <Column gap={ 0 }>
                        ...
                        <Text className="groups-small-text">{ LocalizeText('group.created', [ 'date', 'owner' ], [ groupInformation.createdAt, groupInformation.ownerName ]) }</Text>
                    </Column>
