...
export const FriendsMessengerView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-friends-messenger" uniqueKey="nitro-friends-messenger" theme="messenger">
            ...
            <NitroCardContentView className='overflow-hidden messenger-height'>
                ...
                <Column overflow="hidden" className="w-100">
                    { activeThread &&
                            <>
                                ...
                                <Flex alignItems="center" justifyContent="between" gap={ 1 }>
                                    <Flex gap={ 1 }>
                                        <ButtonGroup className="gap-1">
                                            ...
                                            <Button className="messenger-button fw-bold px-3" onClick={ () => report(ReportType.IM, { reportedUserId: activeThread.participant.id }) }>
                                ...
                                <Flex gap={ 1 }>
                                    <input spellCheck="false" type="text" className="chat-input-form form-control-sm" maxLength={ 255 } placeholder={ LocalizeText('messenger.window.input.default', [ 'FRIEND_NAME' ], [ activeThread.participant.name ]) } value={ messageText } onChange={ event => setMessageText(event.target.value) } onKeyDown={ onKeyDown } />
