...
export const RelationshipsContainerView: FC<RelationshipsContainerViewProps> = props =>
{
            ...
            <Flex fullWidth gap={ 1 }>
                ...
                <Column grow gap={ 0 }>
                    <Flex alignItems="center" justifyContent="between" className="profile-white-bg px-2 py-1 user-relationship">
                        <Text className='font-size-profile' bold underline pointer onClick={ event => (relationshipInfo && (relationshipInfo.randomFriendId >= 1) && GetUserProfile(relationshipInfo.randomFriendId)) }>
    ...
    return (
        <>
            ...
            <RelationshipComponent type={ RelationshipStatusEnum.POOP } />
        </>
    );
}
