    ...
    return (
        <>
            { (!noGiftOption && !currentOffer.isRentOffer) &&
                <Button className="purchase-btn-margin" disabled={ ((purchaseOptions.quantity > 1) || !currentOffer.giftable || isLimitedSoldOut || (purchaseOptions.extraParamRequired && (!purchaseOptions.extraData || !purchaseOptions.extraData.length))) } onClick={ event => purchase(true) }>
