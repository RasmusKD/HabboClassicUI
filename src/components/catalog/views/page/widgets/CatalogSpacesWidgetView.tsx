...
import { AutoGrid, AutoGridProps, Button, ButtonGroup, Column } from '../../../../../common';
...
export const CatalogSpacesWidgetView: FC<CatalogSpacesWidgetViewProps> = props =>
{
    ...
    return (
        <>
            <ButtonGroup className="purchase-buttons">
            ...
            <Column className="grid-bg p-2" size={ 7 } overflow="hidden">
            <AutoGrid className="items-padding-spaces items-overlay" innerRef={ elementRef } columnCount={ columnCount } { ...rest }>
