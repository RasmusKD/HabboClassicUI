        ...
        <Column size={ 12 } overflow="hidden" className="text-black">
            ...
            <Base className="bg-muted rounded p-1">
                ...
                <Column gap={ 1 }>
                    ...
                    <input spellCheck="false" type="text" className="form-control form-control-sm" maxLength={ 64 } value={ eventName } onChange={ event => setEventName(event.target.value) } />
                </Column>
                <Column gap={ 1 }>
                    <Text bold>{ LocalizeText('roomad.catalog_description') }</Text>
                    <textarea spellCheck="false" className="form-control form-control-sm" maxLength={ 64 } value={ eventDesc } onChange={ event => setEventDesc(event.target.value) }/>
                </Column>
                <Column gap={ 1 }>
