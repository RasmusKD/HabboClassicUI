...
export const GuideToolOngoingView: FC<GuideToolOngoingViewProps> = props =>
{
    ...
    return (
        <Column fullHeight>
            ...
            <Column gap={ 1 }>
                <Flex gap={ 1 }>
                    <input spellCheck="false" type="text" className="form-control form-control-sm" placeholder={ LocalizeText('guide.help.request.guide.ongoing.input.empty', [ 'name' ], [ userName ]) } value={ messageText } onChange={ event => setMessageText(event.target.value) } onKeyDown={ onKeyDown } />
