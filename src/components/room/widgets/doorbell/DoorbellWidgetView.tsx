...
import { Base, Button, Column, DraggableWindowPosition, Flex, Grid, Text, NitroCardContentView, NitroCardHeaderView, NitroCardView } from '../../../../common';
...
export const DoorbellWidgetView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-widget-doorbell" windowPosition={ DraggableWindowPosition.TOP_LEFT } theme="primary">
