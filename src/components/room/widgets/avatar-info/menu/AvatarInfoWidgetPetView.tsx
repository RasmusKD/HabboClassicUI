import { PetRespectComposer, PetType, RoomControllerLevel, SecurityLevel, RoomObjectCategory, RoomObjectType, RoomObjectVariable, RoomUnitGiveHandItemPetComposer } from '@nitrots/nitro-renderer';
...
export const AvatarInfoWidgetPetView: FC<AvatarInfoWidgetPetViewProps> = props =>
{
    ...
    {
        return (roomSession.isRoomOwner || GetSessionDataManager().securityLevel >= SecurityLevel.PLAYER_SUPPORT);
    }, [ roomSession ]);
