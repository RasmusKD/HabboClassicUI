        ...
        if(name)
        {
            switch(name)
            {
                ...
                case 'rship_bobba':
                    ...
                    break;
                case 'rship_poop':
                    SendMessageComposer(new SetRelationshipStatusComposer(avatarInfo.webID, MessengerFriend.RELATIONSHIP_POOP));
                    break;
                case 'rship_none':
            ...
            { (mode === MODE_RELATIONSHIP) &&
                <>
                    <Flex className="menu-list-split-4">
                        ...
                        <ContextMenuListItemView onClick={ event => processAction('rship_poop') }>
