            ...
            <Base className="nitro-context-menu bot-chat">
                ...
                <Column className="p-1">
                    <Column gap={ 1 }>
                        ...
                        <textarea spellCheck="false" className="form-control form-control-sm trophy-text" placeholder={ LocalizeText('bot.skill.chatter.configuration.text.placeholder') } value={ newText } rows={ 7 } onChange={ e => setNewText(e.target.value) } />
                    </Column>
                    <Column gap={ 1 }>
                        <Flex gap={ 1 } alignItems="center" justifyContent="between">
                            ...
                            <input type="checkbox" className="flash-form-check-input" checked={ automaticChat } onChange={ event => setAutomaticChat(event.target.checked) } />
                        </Flex>
                        <Flex gap={ 1 } alignItems="center" justifyContent="between">
                            <Text fullWidth variant="white">{ LocalizeText('bot.skill.chatter.configuration.markov') }</Text>
                            <input type="checkbox" className="flash-form-check-input" checked={ mixSentences } onChange={ event => setMixSentences(event.target.checked) } />
                        </Flex>
                        <Flex gap={ 1 } alignItems="center" justifyContent="between">
