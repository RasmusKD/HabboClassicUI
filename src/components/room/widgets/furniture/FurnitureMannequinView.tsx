...
export const FurnitureMannequinView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-mannequin no-resize" theme="primary">
                ...
                <Flex fullWidth gap={ 2 } overflow="hidden">
                    ...
                    <Column grow justifyContent="between" overflow="auto">
                        { (mode === MODE_CONTROLLER) &&
                            <>
                                <input spellCheck="false" type="text" className="form-control form-control-sm" value={ name } onChange={ event => setName(event.target.value) } onBlur={ saveName } />
                                <Column gap={ 1 }>
