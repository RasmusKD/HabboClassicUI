...
import { LayoutAvatarImageView, LayoutGridFurni } from '../../../../common';
...
export const InventoryBotItemView: FC<PropsWithChildren<{ botItem: IBotItem }>> = props =>
{
    ...
    return (
        <LayoutGridFurni itemActive={ (selectedBot === botItem) } itemUnseen={ unseen } onMouseDown={ onMouseEvent } onMouseUp={ onMouseEvent } onMouseOut={ onMouseEvent } { ...rest }>
