...
export const ModToolsUserRoomVisitsView: FC<ModToolsUserRoomVisitsViewProps> = props =>
{
    ...
    return (
        <NitroCardView className="nitro-mod-tools-user-visits no-resize" theme="modtool-windows" windowPosition={ DraggableWindowPosition.TOP_CENTER }>
            <NitroCardHeaderView headerText={ 'Bruger Besøg' } onCloseClick={ onCloseClick } />
                ...
                <Column fullHeight gap={ 0 } overflow="hidden">
                    <Column gap={ 2 }>
                        <Grid gap={ 1 } className="text-black fw-bold border-bottom pb-1">
                            <Base className="g-col-2">Tid</Base>
                            <Base className="g-col-7">Rum navn</Base>
