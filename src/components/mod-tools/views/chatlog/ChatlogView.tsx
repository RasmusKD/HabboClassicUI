 ...
 export const ChatlogView: FC<ChatlogViewProps> = props =>
 {
     ...
     {
        return (
            <Flex gap={ 2 } alignItems="center" justifyContent="between" className="bg-muted p-1">
                <Flex gap={ 1 }>
                    <Text gfbold>Rum navn:</Text>
                    <Text>{ props.roomName }</Text>
                </Flex>
                <Flex gap={ 1 }>
                    <Button className="volter-button" onClick={ event => TryVisitRoom(props.roomId) }>Gå til rum</Button>
                    <Button className="volter-button" onClick={ event => openRoomInfo(props.roomId) }>Rumværktøj</Button>
                </Flex>
            </Flex>
        );
    }
    ...
    return (
        <>
            <Column fit gap={ 0 } overflow="hidden">
                <Column gap={ 2 }>
                    <Grid gap={ 1 } className="pb-1">
                        <Base className="g-col-1">Tid</Base>
                        <Base className="g-col-3">Bruger</Base>
                        <Base className="g-col-7">Besked</Base>
                    </Grid>
                </Column>
