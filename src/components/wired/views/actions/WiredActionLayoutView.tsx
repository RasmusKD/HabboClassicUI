...
import { WiredActionXYZMovementView } from './WiredActionXYZMovementView';
import { WiredActionStackChanceView } from './WiredActionStackChanceView';
...
export const WiredActionLayoutView = (code: number) =>
{
    switch(code)
    {
        ...
        case WiredActionLayoutCode.ROLLERSPEED:
            return <WiredActionRollerSpeedView />;
        case WiredActionLayoutCode.POINTS_NO_GAME:
            return <WiredActionPointsNoGameView />;
        case WiredActionLayoutCode.XYZ_MOVEMENT:
            return <WiredActionXYZMovementView />;
        case WiredActionLayoutCode.STACK_CHANCE:
            return <WiredActionStackChanceView />;
        case WiredActionLayoutCode.TAGS:
            return <WiredActionTagsView />;
        case WiredActionLayoutCode.DISTANCE:
