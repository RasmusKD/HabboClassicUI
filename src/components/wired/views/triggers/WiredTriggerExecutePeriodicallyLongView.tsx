    ...
    return (
        <WiredTriggerBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_NONE } hasSpecialInput={ true } save={ save }>
            <Column gap={ 1 }>
                ...
                <Text className='slider-text-margin' gfbold>{ LocalizeText('wiredfurni.params.setlongtime', [ 'time' ], [ FriendlyTime.format(time * 5).toString() ]) }</Text>
                <Flex className='wired-slider-buttons wired-help-bottom'>
                    ...
                    <ReactSlider
                        ...
                        <Button disabled={ ((time === 120)) }className="notification-buttons help-button-size" onClick={ handleNext }>
