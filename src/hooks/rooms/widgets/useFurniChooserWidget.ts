...
const useFurniChooserWidgetState = () =>
{
    ...
    const populateChooser = () =>
    {
        ...
        setItems([ ...wallItems, ...floorItems ].sort((a, b) => ((a.name.toLowerCase() < b.name.toLowerCase()) ? -1 : 1)));
    }
    ...
    useFurniAddedEvent(!!items, event =>
    {
        ...
        setItems(prevValue => [ ...prevValue, item ].sort((a, b) => ((a.name.toLowerCase() < b.name.toLowerCase()) ? -1 : 1)));
    });
